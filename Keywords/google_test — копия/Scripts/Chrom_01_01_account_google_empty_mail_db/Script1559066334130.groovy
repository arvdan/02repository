...
'ввод пустого значения почты'
WebUI.setText(findTestObject('Page_ Google/input_Google_identifier'), '@gmail.com')
...
css_border = WebUI.getCSSValue(findTestObject('Page_ Google/div_for_border_red'), 'border')

'проверяем соотвествие параметрам рамки'
WebUI.verifyEqual(css_border, '2px solid rgb(217, 48, 37)')
